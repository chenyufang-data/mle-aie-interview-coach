...
Generated 2026-09-06T03:45:15 by `grader/grounding_r4.py --score` --run grown. Probes: 77 resume-only mock probes (`grader/grounding_probes_resume_only.jsonl`). Labels: Claude (assistant), blind to policy attachment, at the author's request; 156 of 237 pair labels reused verbatim from the first run, 81 new. Rule R4 (frozen in docs/dense_retrieval_plan.md §12.4): precision ≥ 90% at coverage ≥ 40%; coverage = probes receiving a fair rubric / probes; precision = fair / attached. Thresholds: {'bm25': 10.0, 'dense': 0.5746, 'hybrid': 0.0284, 'dense_floor': 0.7}.
